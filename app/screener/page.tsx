...
export const metadata: Metadata = {
  ...
  description:
    "Beantworte 66 Fragen entlang elf Dimensionen, um dein individuelles ADHS-Profil zu erkunden.",
};
    ...
    <main className="flex flex-1 flex-col px-6 py-16 sm:px-8 lg:px-12">
      <div className="mx-auto w-full max-w-3xl">
        ...
        <p className="mb-12 text-center text-lg text-muted-foreground">
          66 Fragen entlang elf Dimensionen. Nimm dir die Zeit, die du brauchst.
        </p>
        <ScreenerClient />
      </div>
    </main>
