      ...
      <div className="mx-auto w-full max-w-2xl">
        <header className="text-center">
          ...
          <a
            href="/about.epub"
            download
            className="mt-5 inline-flex items-center gap-2 rounded-full border border-border bg-card px-4 py-2 text-sm font-medium text-foreground transition-colors hover:bg-muted"
          >
        ...
        {lastEditedLabel && (
          <div className="mt-6 text-center">
            <span className="inline-block -rotate-2 rounded border-2 border-primary px-3 py-1 font-mono text-xs font-medium text-primary">
